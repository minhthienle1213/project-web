	...
	<div class="box">
		...
		<div class="inner-box">
			...
			<form action="thanks.jsp" method="post">
				...
				<input style="font-size: 17px;" type="text" name="fullname"
					placeholder="Your full name" required /> <input
					style="font-size: 17px;" type="text" name="username"
					placeholder="User name" required /> <input style="font-size: 17px;"
					type="email" name="email" placeholder="Email address" required /> <input
					style="font-size: 17px;" type="password" name="password"
					placeholder="Password" required /> <input style="font-size: 17px;"
					type="password" name="conformpassword"
					placeholder="Conform password" required /> <input
					style="font-size: 17px;" type="submit" value="Sign up" />
				...
				<p style="text-align: right;">
					<span>Already register ? </span><a class="link" href="login.jsp">Sign
						in</a>
				</p>
