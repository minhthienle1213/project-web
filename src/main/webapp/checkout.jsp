			...
			<div class="row">
				<div class="col-md-4">
					...
					<div class="single-sidebar">
						...
						<ul>
							<li><a href="single-product.jsp">Laptop Acer Nitro 5
									Gaming AN515 57 727J i7 11800H/8GB/512GB/4GB</a></li>
									...
									<table class="shop_table">
										...
										<tbody>
											<tr class="cart_item">
												...
												<td class="product-total"><span class="amount">10.390.000
														đ</span></td>
											</tr>
										</tbody>
										<tfoot>
											...
											<tr class="cart-subtotal">
												<th>Cart subtotal</th>
												<td><span class="amount">10.390.000 đ</span></td>
											</tr>
											...
											<tr class="order-total">
												<th>Order total</th>
												<td><strong><span class="amount">10.390.000
															đ</span></strong></td>
											</tr>
