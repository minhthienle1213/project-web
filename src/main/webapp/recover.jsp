 ...
 <li ><a href="index.jsp">Home</a></li>
	...
	<div class="box">
		...
		<div class="inner-box">
			...
			<h4 style="text-align: center;">Email Verification Link Has Been
				Sent !</h4>
			</p>
			<p style="text-align: center;">We send varification link on your
				providing email address please confrom your email address and login
				to your account.</p>
			<br />
			<p style="text-align: center;">
				Go Back to <a class="link" href="login.jsp">Login Page</a>
			</p>
		</div>
